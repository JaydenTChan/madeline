...
switch(global.state){
    case 0: //INPUT 1
        if(LA == "look around"||LA == "look"){
            ...
            door = true;
        }else if(door &&(LA == "close door" || LA == "close the door")) {
    ...
    case 1: //INPUT 2
        if(LA == "look around"||LA == "look"){
            ds_list_add(global.log, "You can't see much in the darkness.");
        }else if(!founddoor&&(LA == "turn on light" || LA == "flip the switch"||LA == "flip light")){
            ...
            founddoor = true;
        }else if(!notfounddoor&&(LA == "go forward"||LA=="go straight"||LA=="walk forward"||LA=="walk straight")){
